...
body .container .half.bg {
  background-image: url("/resources/images/img_signup.jpg");
	...
	<div class="content">
		<div class="signin-cont cont">
	    	<form action="#" method="post" enctype="form-data">
				<input type="id" name="email" id="email" class="inpt" required="required" placeholder="Your email">
    	...
    	<div class="signup-cont cont">
            <form action="#" method="post" enctype="form-data" >
				<input type="id" name="id" id="id" class="inpt" required="required" placeholder="Your id" value = "${id}">
					<label for="name">Your name</label>
                <input type="email" name="email" id="email" class="inpt" required="required" placeholder="Your email" value = "${email}">
					<label for="email">Your email</label>
